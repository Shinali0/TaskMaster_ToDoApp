    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mSaveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String habit = mTaskEdit.getText().toString();

                if (finalIsUpdate) {
                    firestore.collection("habit").document(id).update("habit",habit,"due",dueDate);
                    ...
                    if (habit.isEmpty()) {
                        ...
                        if (user != null) {
                            ...
                            firestore.collection("habit").add(taskMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                @Override
                                public void onComplete(@NonNull Task<DocumentReference> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(context, "Habit Activity Saved", Toast.LENGTH_SHORT).show();
                                    } else {
