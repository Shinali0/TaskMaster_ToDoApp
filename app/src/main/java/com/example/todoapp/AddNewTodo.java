    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mSaveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String todo = mTaskEdit.getText().toString();

                if (finalIsUpdate) {
                    firestore.collection("todo").document(id).update("todo",todo,"due",dueDate);
                    Toast.makeText(context,"To Do Activity Updated",Toast.LENGTH_SHORT).show();
                }else {
                            ...
                            firestore.collection("todo").add(taskMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                ...
                                public void onComplete(@NonNull Task<DocumentReference> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(context, "To Do Activity Saved", Toast.LENGTH_SHORT).show();
                                    } else {
